# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [{{template `project_name_alphanumeric_underscore` .}}/assets/README.md](../../assets/README.md)
